...
public class CheckHowToCreateOrderInEdge {
    ...
    public CheckHowToCreateOrderInEdge(String textCheckStatus, String name, String surname, String address, int metroValue, String phone, int day, int rentQuantity, String color) {
